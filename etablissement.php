...
<?php
    ...
    $query_ListeEcole = "SELECT * FROM etablissement where Valider = 0 order by Nom_Etablissement ";
...
if (isset($_POST['Code'])) {
    ...
    //mail('deawfred@gmail.com', 'Mon Sujet', 'OKKK');
    
  $loginUsername=$_POST['NomEtb'];
  $password=$_POST['Code'];
  $MM_fldUserAuthorization      = "";
  $MM_redirectLoginSuccess      = "enquete.php";
  $MM_redirectLoginFailed       = "etablissement.php";
      ...
      <div class="col col-xl-10">
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 col-xl-7 d-flex ">
                ...
                <form method="post" action="">
                  ...
                  <div class="form-outline mb-4 d-grid gap-2">
                        ...
                        <div class="form-group ">
                            <label class="control-label">Etablissement  &nbsp;<i class="bi bi-mortarboard-fill" style="color: orange;"></i> </label>
                                    <div class="input-group">
                                                         
                                        <select  name="NomEtb"  class="selectpicker  mb-3" data-live-search="true">
                                            <?php
            ...
            //                              }
                  ...
                  <div class="form-outline mb-4">
                             <div class="form-group">
                                <label class="control-label">Code  &nbsp;<i class="bi bi-keyboard-fill" style="color: orange;"></i></label>
                ...
                <div class="text-center" ><button type="submit" class="btn btn-primary"  style="margin-top: 30px;" name="Connexion">Connexion</button>
                </div>
