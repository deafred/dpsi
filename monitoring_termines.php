...
if (isset($_SESSION['MM_Adminname']) && isset($_SESSION['MM_Admincode'])) {
    ...
    //Debut de tous les etablissements
        ...
        if($Admin=="admin"){
            $query_ListeEtb = "SELECT * FROM etablissement where Etape_Identification=1 AND Etape_Infrastructures=1 AND Etape_Commodites=1 AND Etape_Personnel=1 AND Etape_Vulnerabilites=1 AND Etape_Partenariats=1 AND Etape_Eleves_Filiere=1 AND Etape_Immobiliers=1 AND Etape_Mobiliers=1 AND Etape_Suivi=1 AND Etape_Demande=1  order by Nom_Etablissement";
        }else{
            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-end" data-aos="fade-right">
                    Filtre&nbsp;:&nbsp; <select class="form-select-sm " style='width: 25%;display: inline;'  onChange="location.href=''+this.options[this.selectedIndex].value+'';">
                                ...
                                <option value="#" selected>Termin&eacute;s</option>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">Termin&eacute;s</li>
