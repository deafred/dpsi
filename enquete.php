...
$query_Liste_Filiere = "SELECT * FROM liste_filiere order by Nom_Filiere";
...
//Affiche tous les Classes pour le Recap.
$query_Salle_Classe = "SELECT * FROM Immobilier where Code_dspss_I='$Password'  AND Nom_Infrastructure ='".SALLE_CLASSE."'";
    $Liste_Classe           =   $idcom->query($query_Salle_Classe);
    $row_Liste_Classe       =   $Liste_Classe->fetchObject();
    $totalRows_Liste_Classe =   $Liste_Classe->rowCount();


    $Nbre_Apprenant_Technique               =   0;
    $Nbre_Apprenant_Professionnel           =   0;
    $Nbre_Apprenant_Apprentissage           =   0;
    $Nbre_Apprenant_Quanlifiante            =   0;
    $Effectif_Apprenant                     =   0;


//Affiche le nombre d'apprenant PAR FORMATION
$query_Effectif_Apprenant = "SELECT * FROM eleves_filiere where Code_dspss_R='$Password' ";
    $Liste_Effectif_Apprenant               =   $idcom->query($query_Effectif_Apprenant);
    $totalRows_Liste_Effectif_Apprenant     =   $Liste_Effectif_Apprenant->rowCount();

    while($row_Liste_Effectif_Apprenant     =   $Liste_Effectif_Apprenant->fetchObject()){
        
        $Formation_Apprenant                =   $row_Liste_Effectif_Apprenant->Formation;
        $Nbre_Apprenant                     =   $row_Liste_Effectif_Apprenant->Eff_Stagiaire_Garcon + $row_Liste_Effectif_Apprenant->Eff_Stagiaire_Fille;
        
        if ($Formation_Apprenant            ==  TECH    ){
            $Nbre_Apprenant_Technique       = $Nbre_Apprenant_Technique + $Nbre_Apprenant;
        }else if ($Formation_Apprenant      ==  PROF    ){
            $Nbre_Apprenant_Professionnel   = $Nbre_Apprenant_Professionnel + $Nbre_Apprenant;
        }else if ($Formation_Apprenant      ==  APPRENTISSAGE    ){
            $Nbre_Apprenant_Apprentissage = $Nbre_Apprenant_Apprentissage + $Nbre_Apprenant;
        }else if ($Formation_Apprenant      ==  QUALIFIANTE    ){
            $Nbre_Apprenant_Quanlifiante    = $Nbre_Apprenant_Quanlifiante + $Nbre_Apprenant;
        }
        $Effectif_Apprenant = $Effectif_Apprenant + $Nbre_Apprenant;
    }


    $Nbre_Demande_Technique                 =   0;
    $Nbre_Demande_Professionnel             =   0;
    $Nbre_Demande_Apprentissage             =   0;
    $Nbre_Demande_Quanlifiante              =   0;
    $Effectif_Demande                       =   0;

//Affiche le nombre d'apprenant DEMANDE
$query_Demande_Apprenant = "SELECT * FROM Demande where Code_dspss_D='$Password' ";
    $Liste_Demande_Apprenant               =   $idcom->query($query_Demande_Apprenant);
    $totalRows_Liste_Demande_Apprenant     =   $Liste_Demande_Apprenant->rowCount();

    while($row_Liste_Demande_Apprenant     =   $Liste_Demande_Apprenant->fetchObject()){
        
        $Formation_Demande                =   $row_Liste_Demande_Apprenant->Formation;
        $Nbre_Demande                     =   $row_Liste_Demande_Apprenant->Nombre_Affecte_Demande;
        
        if ($Formation_Demande            ==  TECH    ){
            $Nbre_Demande_Technique       = $Nbre_Demande_Technique + $Nbre_Demande;
        }else if ($Formation_Demande      ==  PROF    ){
            $Nbre_Demande_Professionnel   = $Nbre_Demande_Professionnel + $Nbre_Demande;
        }else if ($Formation_Demande      ==  APPRENTISSAGE    ){
            $Nbre_Demande_Apprentissage = $Nbre_Demande_Apprentissage + $Nbre_Demande;
        }else if ($Formation_Demande      ==  QUALIFIANTE    ){
            $Nbre_Demande_Quanlifiante    = $Nbre_Demande_Quanlifiante + $Nbre_Demande;
        }
        
        $Effectif_Demande = $Effectif_Demande + $Nbre_Demande;
    }
...
//            echo $row_ListeEtb->Nom_Etablissement; 
            ...
            header("Location: ". 'etablissement.php' );//****** redirig&eacute;e vers une page erreur
        }
        ...
        <div class="row">
          <div class="col-lg-3" data-aos="fade-right">
            ...
            ?>                       
                        ...
                        Taux de reussite (<?php   echo $Status."/".$Total; ?>)
                    </h4>
                    ...
                    <div> <a href="#debut"><button type="button" class="btn btn-etape10 btn-taille" id="bt_recapitulatif" name="bt_recapitulatif" onclick="location.href='enquete.php?etape=recapitulatif#debut'">R&eacute;cap. des &eacute;tapes&nbsp;&nbsp;&nbsp;<i class="bi bi-caret-right"></i></button></a>
                    </div>                    
...
<!--Ordre Formation-->   
             <div class="etiquette mt-3">Ordre de formation</div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="Enseignement" id="T" value="<?php echo $Technique; ?>" <?php if  ($row_ListeEtb->Ordre_Formation==$Technique){echo 'Checked';} ?> required>
                    <label class="form-check-label" for="T">Ens. Technique</label>
                </div>
                 <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="Enseignement" id="P" value="<?php echo $Professionnel ; ?>" <?php if  ($row_ListeEtb->Ordre_Formation==$Professionnel){echo 'Checked';} ?>>
                    <label class="form-check-label" for="P">Ens. Professionnel</label>
                </div>
                 <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="Enseignement" id="TP" value="<?php echo $Tech_Prof ; ?>" <?php if  ($row_ListeEtb->Ordre_Formation==$Tech_Prof){echo 'Checked';} ?>>
             ...
             <div class="etiquette mt-3">Statut de l'Etablissement<input name="Hidden_Statut" type="hidden" value="<?php echo $row_ListeEtb->Statut_Etablissement ?>" id="Hidden_Statut"></div>
              ...
              <div class="etiquette mt-3">Situation de l'&eacute;tablissement ann&eacute;e<?php echo ANNEE_SCO ; ?></div>
                <div class="form-check  form-group">
                    <input class="form-check-input" type="radio" name="Situation_Etablissement" id="Fonctionnel" value="<?php echo $Fonctionnel; ?>" <?php if ($row_ListeEtb->Situation_Etablissement==$Fonctionnel){echo 'Checked';} ?> required>
                    <label class="form-check-label" for="Fonctionnel">Avec des apprenants du technique ou professionnel</label>
                </div>
                 <div class="form-check ">
                    <input class="form-check-input" type="radio" name="Situation_Etablissement" id="Non-Fonctionnel" value="<?php echo $Non_Fct; ?>" <?php if ($row_ListeEtb->Situation_Etablissement==$Non_Fct){echo 'Checked';} ?>>
                    <label class="form-check-label" for="Non-Fonctionnel"> Sans apprenants du technique ou professionnel</label>
                     <input type="hidden" value="<?php echo $row_ListeEtb->Situation_Etablissement; ?>" name="Hidden_Situation">
                </div>
              ...
              <div class="row mt-3" >
                ...
                <div class="col-md-3 form-group">
                  ...
                  <input type="text" name="Tel1" class="form-control" id="Tel1" placeholder="00 00 00 00 00" required value="<?php echo $row_ListeEtb->Tel1_Etablissement; ?>" pattern="[02][1-9][ ][0-9]{2}[ ][0-9]{2}[ ][0-9]{2}[ ][0-9]{2}">
                </div>
                <div class="col-md-3 form-group">
                  <div>T&eacute;l. 2</div>
                  <input type="text" name="Tel2" class="form-control" id="Tel2" placeholder="00 00 00 00 00" value="<?php echo $row_ListeEtb->Tel2_Etablissement; ?>" pattern="[02][1-9][ ][0-9]{2}[ ][0-9]{2}[ ][0-9]{2}[ ][0-9]{2}">
                </div>
                ...
                <div class="col-md-3 form-group mt-3 mt-md-0">
                    <div>*E-mail</div>
                  <input type="text" class="form-control" name="Email" id="Email" placeholder="email" required value="<?php echo $row_ListeEtb->Email_etablissement; ?>" pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$">
                </div>
              </div> 
              ...
              <div class="row" id="et-fondateur">  
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" name="Nom_Fond" class="form-control majuscule" id="Nom_Fond" placeholder="Nom" required value="<?php echo htmlentities($row_ListeEtb->Nom_Fondateur); ?>">
                </div>
                <div class="col-md-6 form-group mt-6 mt-md-0">
                    <div>*Contact Fondateur</div>
                  <input type="text" class="form-control" name="Contact_Fond" id="Contact_Fond" placeholder="00 00 00 00 00" required value="<?php echo $row_ListeEtb->Contact_Fondateur; ?>" pattern="[02][1-9][ ][0-9]{2}[ ][0-9]{2}[ ][0-9]{2}[ ][0-9]{2}">
                </div>    
              </div>
              ...
              <div class="row mt-3">
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" name="Nom_Chef_Ecole" class="form-control majuscule" id="Nom_Chef_Ecole" placeholder="Nom" required value="<?php echo htmlentities($row_ListeEtb->Nom_Chef_Ecole); ?>">
                </div>
                <div class="col-md-6 form-group mt-6 mt-md-0">
                    <div>*Contact Chef Etabl.</div>
                  <input type="text" class="form-control" name="Contact_Chef_Ecole" id="Contact_Chef_Ecole" placeholder="00 00 00 00 00" required value="<?php echo $row_ListeEtb->Contact_Chef_Ecole; ?>" pattern="[02][1-9][ ][0-9]{2}[ ][0-9]{2}[ ][0-9]{2}[ ][0-9]{2}">
                </div>
              </div>                
               ...
               <div class="row mt-3">
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" name="Nom_DE1" class="form-control majuscule" id="Nom_DE1" placeholder="Nom" required value="<?php echo htmlentities($row_ListeEtb->Nom_DE1); ?>">
                </div>
                <div class="col-md-6 form-group mt-6 mt-md-0">
                    <div>*Contact Censeur ou DE (1)</div>
                  <input type="text" class="form-control" name="Contact_DE1" id="Contact_DE1" placeholder="00 00 00 00 00" required value="<?php echo $row_ListeEtb->Contact_DE1; ?>" pattern="[02][1-9][ ][0-9]{2}[ ][0-9]{2}[ ][0-9]{2}[ ][0-9]{2}">
                </div>
              </div>               
                ...
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" name="Nom_DE2" class="form-control majuscule" id="Nom_DE2" placeholder="Nom" value="<?php echo htmlentities($row_ListeEtb->Nom_DE2); ?>">
                </div>
                <div class="col-md-6 form-group mt-6 mt-md-0">
                    <div>Contact Censeur ou DE (2)</div>
                  <input type="text" class="form-control" name="Contact_DE2" id="Contact_DE2" placeholder="00 00 00 00 00" value="<?php echo $row_ListeEtb->Contact_DE2; ?>" pattern="[02][1-9][ ][0-9]{2}[ ][0-9]{2}[ ][0-9]{2}[ ][0-9]{2}">
                </div>
              </div>                
...
<!--Capacité Accueil-->
             ...
             <div class="etiquette mt-3">Capacit&eacute; d'accueil (&eacute;l&egrave;ves) de l'&eacute;tablissement </div>                    
                <div class="col-md-6 form-group">
                    <input class="form-control" type="number" min="100" max="10000" name="Capacite_Accueil" id="Capacite_Accueil"  required value="<?php echo $row_ListeEtb->Capacite_Accueil ?>">                  
                </div>
                </div>    
...
<!--Eau-->
                ...
                <div class="col-md-4 form-group">
                        <input type="number"  max="100" name="Nbre_Eau_Potable" class="form-control" id="Nbre_Eau_Potable" placeholder="Nombre" value="<?php echo $row_ListeEtb->Nbre_Eau_Potable; ?>">
                </div>
              </div>
                ...
                <div id="et-cantine-fct">
                  <div class="row mt-3">
                   ...
                   <div class="row mt-3">
                    ...
                    <div class="col-md-4 form-group">
                             <input type="number"  max="7" name="Cantine_Jour_Ouv" class="form-control" id="Cantine_Jour_Ouv" placeholder="Nombre"  value="<?php echo $row_ListeEtb->Cantine_Jour_Ouv; ?>">  
                    </div>
                  </div>
               </div>    
            </div>   
                ...
                <div id="et-internat">
                  ...
                  <div class="row mt-3">
                   ...
                   <div class="row mt-3">
                    ...
                    <div class="col-md-4 form-group">
                             <input type="number"  max="1000" name="Nbre_Lits" class="form-control" id="Nbre_Lits" placeholder="Nombre"  value="<?php echo $row_ListeEtb->Nbre_Lits; ?>">  
                    </div>
                  </div>            
             </div>   
                ...
                <div id="et-latrine">
                  ...
                  <div class="row mt-3">
                     <div class="col-md-4 form-group">
                      ...
                      <input type="number"  max="20" name="Nbre_Latrine_Garcon" class="form-control" id="Nbre_Latrine_Garcon" value="<?php echo $row_ListeEtb->Nbre_Latrine_Garcon; ?>" >
                    </div>                 
                    <div class="col-md-4 form-group">
                      <div>Nbre Latrine Fille</div>
                      <input type="number"  max="20" name="Nbre_Latrine_Fille" class="form-control" id="Nbre_Latrine_Fille" value="<?php echo $row_ListeEtb->Nbre_Latrine_Fille; ?>" >
                    </div>
                    <div class="col-md-4 form-group mt-3 mt-md-0">
                        <div>Nbre Latrine Mixte</div>
                      <input type="number"  max="20" class="form-control" name="Nbre_Latrine_Mixte" id="Nbre_Latrine_Mixte" value="<?php echo $row_ListeEtb->Nbre_Latrine_Mixte; ?>" >
                    </div>
                  </div>
             </div>
                ...
                <div id="et-salle-info">
                  ...
                  <div class="row mt-3">
                     <div class="col-md-6 form-group">
                      ...
                      <input type="number"  max="1000" name="Nbre_Ordi" class="form-control" id="Nbre_Ordi"  value="<?php echo $row_ListeEtb->Nbre_Ordi; ?>">
                    </div>                 
                    <div class="col-md-6 form-group">
                      <div>Nbre de postes fonctionnels</div>
                      <input type="number"  max="1000" name="Nbre_Ordi_Fonctionnel" class="form-control" id="Nbre_Ordi_Fonctionnel"  value="<?php echo $row_ListeEtb->Nbre_Ordi_Fonctionnel; ?>" >
                    </div>
                  </div>                
...
<!--Grêve des enseignants-->
             <div class="etiquette mt-3">Gr&ecirc;ve des enseignants</div>
              <div class="row">
                <div class="col-md-6 form-group">
                    <div>Nombre</div>
                  <input type="number" min="0" max="20" name="Nbre_Greve_Prof" class="form-control" id="Nbre_Greve_Prof" value="<?php echo $row_ListeEtb->Nbre_Greve_Prof; ?>" required>
                </div>
                <div class="col-md-6 form-group">
                    <div>Nb. Heures perdues</div>
                  <input type="number" min="0" max="2000" name="Heure_Greve_Prof" class="form-control" id="Heure_Greve_Prof" value="<?php echo $row_ListeEtb->Heure_Greve_Prof; ?>" required>
                </div>
              </div>                 
...
<!--Grêve des élève-->
             <div class="etiquette mt-3">Gr&ecirc;ve des &eacute;l&egrave;ves</div>
              <div class="row">
                <div class="col-md-6 form-group">
                    <div>Nombre</div>
                  <input type="number" min="0" max="20" name="Nbre_Greve_Apprenant" class="form-control" id="Nbre_Greve_Apprenant" value="<?php echo $row_ListeEtb->Nbre_Greve_Apprenant; ?>" required>
                </div>
                <div class="col-md-6 form-group">
                    <div>Nb. Heures perdues</div>
                  <input type="number" min="0" max="2000" name="Heure_Greve_Apprenant" class="form-control" id="Heure_Greve_Apprenant" value="<?php echo $row_ListeEtb->Heure_Greve_Apprenant; ?>" required>
                </div>
              </div>                 
...
<!--Autres Grêves-->
             <div class="etiquette mt-3">Autres pertubations</div>
              <div class="row">
                <div class="col-md-6 form-group">
                    <div>Nombre</div>
                  <input type="number" min="0" max="20" name="Nbre_Autre_Greve" class="form-control" id="Nbre_Autre_Greve" value="<?php echo $row_ListeEtb->Nbre_Autre_Greve; ?>" required>
                </div>
                <div class="col-md-6 form-group">
                    <div>Nb. Heures perdues</div>
                  <input type="number" min="0" max="2000" name="Heure_Autre_Greve" class="form-control" id="Heure_Autre_Greve" value="<?php echo $row_ListeEtb->Heure_Autre_Greve; ?>" required>
                </div>
              </div>
             ...
             <div class="etiquette mt-3">Apprenants vivant avec un <strong class="titre-vert">Handicap</strong></div>
              <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <input type="number" min="0" max="100" name="Garcon_Handicap" class="form-control" id="Garcon_Handicap" value="<?php echo $row_ListeEtb->Garcon_Handicap; ?>" required>
                </div>
                <div class="col-md-6 form-group">
                    <div>Fille</div>
                  <input type="number" min="0" max="100" name="Fille_Handicap" class="form-control" id="Fille_Handicap" value="<?php echo $row_ListeEtb->Fille_Handicap; ?>" required>
                </div>
              </div>
 ...
 <!--Personne vivant avec une maladie invalidante-->
             <div class="etiquette mt-3">Apprenants vivant avec une maladie <strong class="titre-orange">maladie invalidante </strong>(causant son abscence)</div>
              <div class="row">
                <div class="col-md-6 form-group">
                    <div>Gar&ccedil;on</div>
                  <input type="number" min="0" max="100" name="Garcon_Maladie_Invalidante" class="form-control" id="Garcon_Maladie_Invalidante" value="<?php echo $row_ListeEtb->Garcon_Maladie_Invalidante; ?>" required>
                </div>
                <div class="col-md-6 form-group">
                    <div>Fille</div>
                  <input type="number" min="0" max="100" name="Fille_Maladie_Invalidante" class="form-control" id="Fille_Maladie_Invalidante" value="<?php echo $row_ListeEtb->Fille_Maladie_Invalidante; ?>" required>
                </div>
              </div> 
             ...
             <div class="etiquette mt-3">Cas de <strong class="titre-rose">grossesse</strong></div>
              <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <input type="number" min="0" max="30" name="Grossesse" class="form-control" id="Grossesse" value="<?php echo $row_ListeEtb->Grossesse; ?>" required>
                </div>
                <div class="col-md-6 form-group">
                    <div>Nombre d'abandon</div>
                  <input type="number" min="0" max="30" name="Grossesse_Abandon" class="form-control" id="Grossesse_Abandon" value="<?php echo $row_ListeEtb->Grossesse_Abandon; ?>" required>
                </div>
              </div> 
             ...
             <div class="etiquette mt-3"> Effectif des cas de <strong class="titre-rouge">violences</strong></div>
              <div class="row">
                <div class="col-md-4 form-group">
                  ...
                  <input type="number" min="0" max="100" name="Blessure" class="form-control" id="Blessure" value="<?php echo $row_ListeEtb->Blessure; ?>" required>
                </div>
                <div class="col-md-4 form-group">
                    <div>Bastonnade</div>
                  <input type="number" min="0" max="100" name="Bastonnade" class="form-control" id="Bastonnade" value="<?php echo $row_ListeEtb->Bastonnade; ?>" required>
                </div>
                <div class="col-md-4 form-group">
                    <div>Corv&eacute;e</div>
                  <input type="number" min="0" max="100" name="Corvee" class="form-control" id="Corvee" value="<?php echo $row_ListeEtb->Corvee; ?>" required>
                </div>
              </div>
              ...
              <div class="row">                
                <div class="col-md-4 form-group">
                  ...
                  <input type="number" min="0" max="100" name="Attouchement" class="form-control" id="Attouchement" value="<?php echo $row_ListeEtb->Attouchement ?>" required>
                </div>
                <div class="col-md-4 form-group">
                    <div>Harcelement sexuel</div>
                  <input type="number" min="0" max="100" name="Harcelement" class="form-control" id="Harcelement" value="<?php echo $row_ListeEtb->Harcelement; ?>" required>
                </div>
                 <div class="col-md-4 form-group">
                    <div>Viol</div>
                  <input type="number" min="0" max="100" name="Viol" class="form-control" id="Viol" value="<?php echo $row_ListeEtb->Viol; ?>" required>
                </div>                   
              </div>                
               ...
               <div class="row">
                <div class="col-md-4 form-group">
                  ...
                  <input type="number" min="0" max="100" name="Mutilation" class="form-control" id="Mutilation" value="<?php echo $row_ListeEtb->Mutilation; ?>" required>
                </div>
                <div class="col-md-4 form-group">
                    <div>Mariage forc&eacute;</div>
                  <input type="number" min="0" max="100" name="Mariage_Force" class="form-control" id="Mariage_Force" value="<?php echo $row_ListeEtb->Mariage_Force; ?>" required>
                </div>
                <div class="col-md-4 form-group">
                    <div>Intimidation</div>
                  <input type="number" min="0" max="100" name="Intimidation" class="form-control" id="Intimidation" value="<?php echo $row_ListeEtb->Intimidation; ?>" required>
                </div>
              </div>                
               ...
               <div class="row">
                ...
                <div class="col-md-4 form-group">
                    <div>Humiliation</div>
                  <input type="number" min="0" max="100" name="Humiliation" class="form-control" id="Humiliation" value="<?php echo $row_ListeEtb->Humiliation; ?>" required>
                </div>
              </div>                 
...
<!--SERFE-->
                ...
                <div class="col-md-6 form-group">
                        <input type="number" min="0" max="4" name="Nbre_Serfe" class="form-control" id="Nbre_Serfe" value="<?php echo $row_ListeEtb->Nbre_Serfe; ?>">
                </div>
              </div> 
...
<!--Partenaires formels-->
                ...
                <div class="col-md-4 form-group">
                        <input type="number"  max="200" name="Nbre_Part_Formel" class="form-control" id="Nbre_Part_Formel" value="<?php echo $row_ListeEtb->Nbre_Part_Formel; ?>">
                </div>
 ...
 <!--Partenaires Informels-->
                ...
                <div class="col-md-4 form-group">
                        <input type="number" max="200" name="Nbre_Part_Informel" class="form-control" id="Nbre_Part_Informel" value="<?php echo $row_ListeEtb->Nbre_Part_Informel; ?>">
                </div>
               <div class="col-md-4 form-group  mt-3">
             ...
             <div class="etiquette mt-3">Personnel enseignant  craie en main <strong class="titre-vert">"permanent"</strong></div>
              <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <input type="number" min="0" max="200" name="Eff_Homme_Prof_Permanent" class="form-control" id="Eff_Homme_Prof_Permanent" value="<?php echo $row_ListeEtb->Eff_Homme_Prof_Permanent; ?>" required>
                </div>
                <div class="col-md-6 form-group">
                    <div>Effectif femme</div>
                  <input type="number" min="0" max="200" name="Eff_Femme_Prof_Permanent" class="form-control" id="Eff_Femme_Prof_Permanent" value="<?php echo $row_ListeEtb->Eff_Femme_Prof_Permanent; ?>" required >
                </div>
              </div>                 
 ...
 <!--Personnel enseignant vacataire-->
             <div class="etiquette mt-3">Personnel enseignant  craie en main <strong class="titre-rouge">"vacataire"</strong></div>
              <div class="row">
                <div class="col-md-6 form-group">
                    <div>Effectif homme</div>
                  <input type="number" min="0" max="100" name="Eff_Homme_Prof_Vacataire" class="form-control" id="Eff_Homme_Prof_Vacataire" value="<?php echo $row_ListeEtb->Eff_Homme_Prof_Vacataire; ?>" required >
                </div>
                <div class="col-md-6 form-group">
                    <div>Effectif femme</div>
                  <input type="number" min="0" max="100" name="Eff_Femme_Prof_Vacataire" class="form-control" id="Eff_Femme_Prof_Vacataire" value="<?php echo $row_ListeEtb->Eff_Femme_Prof_Vacataire; ?>" required >
                </div>
              </div>               
...
<!--Personnel d&rsquo;encadrement-->
             <div class="etiquette mt-3">Personnel d&rsquo;<strong class="titre-gris">Encadrement</strong> (Educateur, Inspecteur d'&eacute;ducation...)</div>
              <div class="row">
                <div class="col-md-6 form-group">
                    <div>Effectif homme</div>
                  <input type="number" min="0" max="20" name="Eff_Homme_Encadreur" class="form-control" id="Eff_Homme_Encadreur" value="<?php echo $row_ListeEtb->Eff_Homme_Encadreur; ?>" required >
                </div>
                <div class="col-md-6 form-group">
                    <div>Effectif femme</div>
                  <input type="number" min="0" max="20" name="Eff_Femme_Encadreur" class="form-control" id="Eff_Femme_Encadreur" value="<?php echo $row_ListeEtb->Eff_Femme_Encadreur; ?>" required >
                </div>
              </div>
 ...
 <!--Personnel Administratif-->
             <div class="etiquette mt-3">Personnel <strong class="titre-rose">Administratif</strong> (Directeur, Secretaire, Econome...)</div>
              <div class="row">
                <div class="col-md-6 form-group">
                    <div>Effectif homme</div>
                  <input type="number" min="0" max="100" name="Eff_Homme_Admn" class="form-control" id="Eff_Homme_Admn" value="<?php echo $row_ListeEtb->Eff_Homme_Admn; ?>" required >
                </div>
                <div class="col-md-6 form-group">
                    <div>Effectif femme</div>
                  <input type="number" min="0" max="100" name="Eff_Femme_Admn" class="form-control" id="Eff_Femme_Admn" value="<?php echo $row_ListeEtb->Eff_Femme_Admn; ?>" required>
                </div>
              </div>               
...
<!--inspection p&eacute;dagogique-->
                ...
                <div class="col-md-6 form-group">
                        <input type="number" min="0" max="400" name="Nbre_Prof_Inspectes" class="form-control" id="Nbre_Prof_Inspectes" value="<?php echo $row_ListeEtb->Nbre_Prof_Inspectes; ?>">
                </div>
              </div> 
...
<!--gr&egrave;ves ou de perturbations-->                
                ...
                <div class="col-md-6 form-group">
                        <input type="number" min="0" max="100" name="Nbre_Pertubation_Scol" class="form-control" id="Nbre_Pertubation_Scol" value="<?php echo $row_ListeEtb->Nbre_Pertubation_Scol; ?>" required>
                </div>
              </div>                
...
<!--heures de cours de perturbations-->                
                ...
                <div class="col-md-6 form-group">
                        <input type="number" min="0" max="5000" name="Nbre_HCours_Perdues" class="form-control" id="Nbre_HCours_Perdues" value="<?php echo $row_ListeEtb->Nbre_HCours_Perdues; ?>">
                </div>
              </div>                
            ...
            <div class="row">
                ...
                <div class="row mt-3">
                 <div class="col-md-4 form-group">
                    ...
                    <input type="number" min="0" max="10000" class="form-control" name="Nbre_Bon_Etat" id="Nbre_Bon_Etat" value="0">
                 </div>
                    
                  <div class="col-md-4 form-group">
                    <div>Capacit&eacute; / Unit&eacute; </div>
                    <input type="number" min="0" max="10000" class="form-control" name="Capacite" id="Capacite" value="0">
                 </div>
                    
                 <div class="col-md-4 form-group">
                    <div>Besoins </div>
                    <input type="number" min="0" max="10000" class="form-control" name="Besoins" id="Besoins" value="0">
                 </div>                    
                ...
                <div class="row mt-3">
                 <div class="col-md-4 form-group">
                    ...
                    <input type="number" min="0" max="10000" class="form-control" name="Nbre_A_Rehabiliter" id="Nbre_A_Rehabiliter" value="0">
                 </div>
                    
                 <div class="col-md-4 form-group">
                    <div>Nbre en r&eacute;habilitation </div>
                    <input type="number" min="0" max="10000" class="form-control" name="Nbre_En_Rehabilitation" id="Nbre_En_Rehabilitation" value="0">
                 </div>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <div>
                        <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="Nom_Mobilier" id="Nom_Mobilier">
                            ...
                            <optgroup label="Mobiliers apprenants">
                                <option value="Ordinateurs salle info">Ordinateurs salle info.</option>
                            ...
                            <optgroup label="Mobiliers administration">
                                  <option value="Ordinateurs administration">Ordinateurs administration</option>
                   ...
                   <div class="etiquette">Nombre</div>
                    <div><input type="number" min="0" max="10000" class="form-control" name="Nbre_Mobilier" id="Nbre_Mobilier" value="0"></div>    
                </div>
                <div class="col-md-6 form-group">
...
<!--Mat&eacute;riels de bureaux-->            
                ...
                <button type="button" class="btn btn-etape3" data-bs-toggle="modal" data-bs-target="#staticBackdrop2" id="modal_eleves_filiere">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                                    ...
                                    <div id="message_recap">
                                           ...
                                           eleves_filiere_reporting($idcom,$Password);
...
//                      }
                ...
                <div class="etiquette">Effectif des Apprenants Inscrits</div>
                 <div class="col-md-6 form-group">
                    ...
                    <input type="number" min="0" max="10000" class="form-control" name="Eff_Stagiaire_Garcon" id="Eff_Stagiaire_Garcon" value="0">
                 </div> 
                 <div class="col-md-6 form-group">
                    <div>Filles </div>
                    <input type="number" min="0" max="10000" class="form-control" name="Eff_Stagiaire_Fille" id="Eff_Stagiaire_Fille" value="0">
                 </div>                    
              </div>  
                ...
                <div class="etiquette">Effectif des affect&eacute;s</div>
                 <div class="col-md-6 form-group">
                    <div>Gar&ccedil;ons</div>
                    <input type="number" min="0" max="10000" class="form-control" name="Eff_Affecte_Garcon" id="Eff_Affecte_Garcon" value="0">
                 </div> 
                 <div class="col-md-6 form-group">
                    <div>Filles </div>
                    <input type="number" min="0" max="10000" class="form-control" name="Eff_Affecte_Fille" id="Eff_Affecte_Fille" value="0">
                 </div>                    
				</div>
                ...
                <div class="etiquette">Admis en classe sup&eacute;rieur</div>
                 <div class="col-md-6 form-group">
                    <div>Gar&ccedil;ons</div>
                    <input type="number" min="0" max="5000" class="form-control" name="Eff_Admis_Garcon" id="Eff_Admis_Garcon" value="0">
                 </div> 
                 <div class="col-md-6 form-group">
                    <div>Filles </div>
                    <input type="number" min="0" max="5000" class="form-control" name="Eff_Admis_Fille" id="Eff_Admis_Fille" value="0">
                 </div>                    
              </div> 
                ...
                <div class="etiquette">R&eacute;doublants</div>
                 <div class="col-md-6 form-group">
                    <div>Gar&ccedil;ons</div>
                    <input type="number" min="0" max="200" class="form-control" name="Eff_Redoublant_Garcon" id="Eff_Redoublant_Garcon" value="0">
                 </div> 
                 <div class="col-md-6 form-group">
                    <div>Filles </div>
                    <input type="number" min="0" max="200" class="form-control" name="Eff_Redoublant_Fille" id="Eff_Redoublant_Fille" value="0">
                 </div>                    
              </div>              
                ...
                <div class="row mt-3">
                 ...
                 <div class="col-md-6 form-group">
                    <div>Gar&ccedil;ons</div>
                    <input type="number" min="0" max="50" class="form-control" name="Eff_Renvoye_Garcon" id="Eff_Renvoye_Garcon" value="0">
                 </div> 
                 <div class="col-md-6 form-group">
                    <div>Filles </div>
                    <input type="number" min="0" max="50" class="form-control" name="Eff_Renvoye_Fille" id="Eff_Renvoye_Fille" value="0">
                 </div>                    
              </div>
                ...
                <div class="row mt-3">
                 ...
                 <div class="col-md-6 form-group">
                    <div>Gar&ccedil;ons</div>
                    <input type="number" min="0" max="50" class="form-control" name="Eff_Report_Garcon" id="Eff_Report_Garcon" value="0">
                 </div> 
                 <div class="col-md-6 form-group">
                    <div>Filles </div>
                    <input type="number" min="0" max="50" class="form-control" name="Eff_Report_Fille" id="Eff_Report_Fille" value="0">
                 </div>                    
              </div>
  ...
  <!--ETAPE Suivi--> 
            ...
            <form action="forms/maj_etape_suivi.php" method="post" role="form" class="mt-4 form-control">
                <div>
                    <input name="Hidden_Suivi" type="hidden" value="<?php echo $row_ListeEtb->Suivi_Apprenant; ?>" id="Hidden_Suivi">
                </div>
                <div>
                    Avez-vous effectuez l'ann&eacute;e derni&egrave;re le suivi de vos apprenants ?&nbsp;&nbsp;&nbsp;

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="Suivi_Apprenant" id="Suivi_Oui" value="Oui" <?php if  ($row_ListeEtb->Suivi_Apprenant=="Oui"){echo 'Checked';} ?> required>
                        <label class="form-check-label" for="Suivi_Oui">Oui</label>
                    </div>
                     <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="Suivi_Apprenant" id="Suivi_Non" value="Non" <?php if  ($row_ListeEtb->Suivi_Apprenant=="Non"){echo 'Checked';} ?>>
                        <label class="form-check-label" for="Suivi_Non">Non</label>
                    </div>                    
              
                </div>
                
            <div id="et-suivi-champs">
<!--Mat&eacute;riels de bureaux-->            

                <div id="suivi-success" class="msg msg-success">
                    <span class="bi bi-check-circle"></span>Succ&egrave;s!!
                </div>
                
                <div id="suivi-warning" class="msg msg-warning">
                    <span class="bi bi-exclamation-triangle"></span>Existe d&eacute;j&agrave;! Supprimez d'abord.
                </div>
                
                <div id="suivi-danger" class="msg msg-danger">
                    <span class="bi bi-exclamation-octagon"></span>Suppression &eacute;ffectu&eacute;e!
                </div>               
                ...
                <div class="row mt-3">
                        ...
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-etape3" data-bs-toggle="modal" data-bs-target="#staticBackdrop3" id="modal_suivi">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                            ...
                                            <div id="message_suivi">
                                                ...
                                                <?php
                                                           suivi_reporting($idcom,$Password);
                ...
                <div class="col-md-4 form-group">
                  ...
                  <div class="col-md-2 form-group">
                     <div class="etiquette_rouge mt-3">Nbre Suivi</div>
                      <input type="number" min="0" max="5000" class="form-control" name="Nombre_Apprenant_Suivi" id="Nombre_Apprenant_Suivi" value="0">
                  </div> 
                ...
                <div class="row mt-3">
                 <div class="etiquette mt-3">Nombre des diplom&eacute;s ayant eu un :</div> 
                  <div class="col-md-4 form-group">
                     <div class="">Stage</div>
                      <input type="number" min="0" max="5000" class="form-control" name="Nombre_Suivi_Stage" id="Nombre_Suivi_Stage" value="0" >
                  </div>
                  <div class="col-md-4 form-group">
                     <div class="">Emploi dans la Sp&eacute;cialit&eacute;</div>
                      <input type="number" min="0" max="1000" class="form-control" name="Nombre_Emploi_Spec" id="Nombre_Emploi_Spec" value="0">
                  </div> 
                  <div class="col-md-4 form-group">
                     <div class="">Emploi hors Sp&eacute;cialit&eacute; &nbsp;&nbsp;</div>
                      <input type="number" min="0" max="1000" class="form-control" name="Nombre_Emploi_Hors_Spec" id="Nombre_Emploi_Hors_Spec" value="0">
                  </div> 
                ...
                <div class="row mt-3">
                  <div class="col-md-4 form-group">
                     <div class="">Auto-Emploi</div>
                      <input type="number" min="0" max="2000" class="form-control" name="Nombre_Auto_Emploi" id="Nombre_Auto_Emploi" value="0">
                  </div> 
                  <div class="col-md-4 form-group">
                     <div class="">Sans Emploi</div>
                      <input type="number" min="0" max="5000" class="form-control" name="Nombre_Sans_Emploi" id="Nombre_Sans_Emploi" value="0">
                  </div>                 
            </div>
...
<!--Mat&eacute;riels de bureaux-->            
                ...
                <div id="demande-danger" class="msg msg-danger"><span class="bi bi-exclamation-octagon"></span>Suppression &eacute;ffectu&eacute;e!</div>               
                 ...
                 <div class="row mt-3">
                        ...
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-etape3" data-bs-toggle="modal" data-bs-target="#staticBackdrop" id="modal_demande">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                            ...
                                            <div id="message_demande">
                                                ...
                                                <?php
                                                    demande_reporting($idcom,$Password);
             ...
             <div class="row mt-3">
                ...
                <div class="col-md-4 form-group">
                 ...
                 <div class="col-md-2 form-group">
                    ...
                    <input type="number" min="0" max="1000" class="form-control" name="Nombre_Affecte_Demande" id="Nombre_Affecte_Demande" value="0">
                 </div>
 ...
 <!--ETAPE Recapitulatif--> 
              ...
              <h3 class="btn-etape2">Etape : R&eacute;capitulatif</h3>
              


            <form action="forms/maj_etape_recapitulatif.php" method="post" role="form" class="mt-4 form-control">

            
                <div class="table-responsive" id="recap_fct">  
                <table border="0" class="table table-light table-striped text-center">
                    <tr>                           
                    ...
                    <tr>
                        <td class="text-start">Capacit&eacute; d'accueil</td>   
                        <td ><?php if ($row_ListeEtb->Capacite_Accueil<>'') {echo $row_ListeEtb->Capacite_Accueil ;}else {echo '0';} ?></td>
                        <td></td>
                        <td></td>  
                        <td></td>  
                    </tr>
                    <tr>
                        <td class="text-start">Nombre de salle classe</td>
                        <td ><?php   if($totalRows_Liste_Classe){echo $row_Liste_Classe->Nbre_Bon_Etat;} else { echo '0';} ?></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td class="text-start">Nombre d'&eacute;l&egrave;ves <strong>(<?php echo $Effectif_Apprenant; ?>)</strong><br> Tech - Prof - Appr - Qualif </td>
                        <td><?php echo $Nbre_Apprenant_Technique; ?></td>
                        <td><?php echo $Nbre_Apprenant_Professionnel; ?></td>
                        <td><?php echo $Nbre_Apprenant_Apprentissage; ?></td>
                        <td><?php echo $Nbre_Apprenant_Quanlifiante; ?></td>
                    </tr>
                    <tr>
                        <td class="text-start">Demande d'affect&eacute;s <strong>(<?php echo $Effectif_Demande; ?>)</strong><br> Tech - Prof - Appr - Qualif</td>
                        <td ><?php echo $Nbre_Demande_Technique; ?></td>
                        <td ><?php echo $Nbre_Demande_Professionnel; ?></td>
                        <td ><?php echo $Nbre_Demande_Apprentissage; ?></td>
                        <td ><?php echo $Nbre_Demande_Quanlifiante; ?></td>
                    </tr>
                    <tr>                           
                        <th colspan="5" class="text-center table-success">
                            STATUT DES ETAPES 
                    ...
                    <tr>
                        <td class="text-start">Identification</td>
                        <td><?php yes_or_no ($row_ListeEtb->Etape_Identification); ?></td>
                        <td></td>
                        <td></td>
                        <td></td>                        
                    </tr>                    
                    <tr>
                        <td class="text-start">Infrastructures</td>
                        <td><?php yes_or_no ($row_ListeEtb->Etape_Infrastructures); ?></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr>  
                    <tr>
                        <td class="text-start">Commodites</td>
                        <td><?php yes_or_no ($row_ListeEtb->Etape_Commodites); ?></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td class="text-start">Personnel</td>
                        <td ><?php yes_or_no ($row_ListeEtb->Etape_Personnel); ?></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr>
                   <tr>
                        <td class="text-start">Pertubations</td>
                        <td><?php yes_or_no ($row_ListeEtb->Etape_Vulnerabilites); ?></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr>                    
                    <tr>
                        <td class="text-start">Partenariats</td>
                        <td><?php yes_or_no ($row_ListeEtb->Etape_Partenariats); ?></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr>  
                    <tr>
                        <td class="text-start">El&egrave;ves / Fili&egrave;re</td>
                        <td ><?php yes_or_no ($row_ListeEtb->Etape_Eleves_Filiere); ?></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr> 
                    <tr>
                        <td class="text-start">Equipements</td> 
                        <td ><?php yes_or_no2 ($row_ListeEtb->Etape_Immobiliers,$row_ListeEtb->Etape_Immobiliers); ?>
                    ...
                    <tr>
                        <td class="text-start">Suivi</td>
                        <td><?php yes_or_no ($row_ListeEtb->Etape_Suivi); ?></td>
                        <td></td>
                        <td></td>
                        <td></td>                        
                    </tr>  
                    <tr>
                        <td class="text-start">Demande</td>
                        <td ><?php yes_or_no ($row_ListeEtb->Etape_Demande); ?></td>
                        <td></td>
                        <td></td>
                        <td></td>                        
                    </tr>   
                ...
                <div class="table-responsive" id="recap_non_fct">  
               <table border="0" class="table table-light table-striped text-center">
                    <tr>                           
                        <th colspan="5" class="text-center table-success">
                            CAPACITES
 ...
 /*CHAMPS DE SUIVI  A MASQUER*/
            $("#et-suivi-champs").hide();       
             if ( $("input[name='Suivi_Apprenant']:checked").val() === 'Oui') { 
                $("#et-suivi-champs").show();
                
            }else{
                $("#et-suivi-champs").hide();
            }        
        
            $("#Suivi_Oui").click(function(){
                $("#et-suivi-champs").show();
            });
            $("#Suivi_Non").click(function(){
                if(confirm('Si vous avez préalablement enregistré des donnees sur le suivi de vos apprenants.\n Elles seront perdues!!!')){
                    maj_etape_suivi_tags();
                    $("#et-suivi-champs").hide();
                    
                }else{
                    $("#Suivi_Oui").prop("checked", true);
                    $("#et-suivi-champs").show();
                }
        
            });        
        
/*BOUTONS*/        /*NON FONCTIONNEL BOUTTONS 5 ET 6  A MASQUER*/
...
//-----------BOUTONS DES MISE A JOUR-----------
        ...
        $("#btn_aj_infras").click(function(){
               //alert ('data');
               if ($("#Capacite").val()==0){
                   alert('Veuillez indiquer la capacit\351');
                }
                else{
  
                        if ($("#Nbre_Bon_Etat").val()>0 || $("#Besoins").val()>0){
                           maj_etape_immobiliers_sucess(); 
                               $("#Nbre_Bon_Etat").val('0');
                               $("#Besoins").val('0');
                               $("#Capacite").val('0');
                               $("#Nbre_A_Rehabiliter").val('0');
                               $("#Nbre_En_Rehabilitation").val('0');
                        }else{
                           alert('Le nombre en bon etat ou le besoin\ndoit \352tre sup\351rieur \340 0');
                        }                   
                   }
        ...
        $("#btn_aj_mobilier").click(function(){
               ...
               if ($("#Nbre_Mobilier").val()>0){
                   ...
                   $("#Nbre_Mobilier").val('0');
                   }else{alert('Le nombre du mobilier doit \352tre sup\351rieur \340 0');}
        ...
        $("#btn_aj_recap").click(function(){
               //alert('aj');
               if ($('#Filiere').val()==''){
                   alert('Veuillez renseigner la fili\350re.');
                   
               } else{
                   
                maj_etape_eleves_filiere_sucess(); 
                   $("#modal_eleves_filiere").click();
        ...
        $("#btn_aj_suivi").click(function(){
               if ($("#Formation_Suivi").val()==''){
                    alert ('Veuillez selectionnez une formation.')
                   
                }else{
                    
                   if ( $("#Nombre_Apprenant_Suivi").val()==0 ){
                       alert ('La valeur du nombre de suivi doit\n\352tre superieur \340 0.');
                    }
                    else{
                        if ($("#Nombre_Suivi_Stage").val()==0 && $("#Nombre_Emploi_Spec").val()==0 && $("#Nombre_Emploi_Hors_Spec").val()==0 && $("#Nombre_Auto_Emploi").val()==0 && $("#Nombre_Sans_Emploi").val()==0){
                            alert ('Une Valeur de\nStage \nEmploi Spec \nEmploi Hors Spec \nAuto Emploi \nSans Emploi \ndoit \352tre sup. \340 0.');
                        }
                        else{
        ...
        $("#btn_aj_demande").click(function(){
               //alert('aj demande');
               if ( $("#Formation_Demande").val() ==''){
                   alert('Veuillez s\351lectionner la formation.');
                }
                else{
                    if ($("#Nombre_Affecte_Demande").val() < 25){
                       alert('La demande doit \352tre sup\351rieur ou \351gale \340 25.'); 
                    }
                    else {
                        maj_etape_demande_sucess(); 
                        $("#Nombre_Affecte_Demande").val('0'); 
                        $("#modal_demande").click();
                    }
