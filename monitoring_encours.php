         ...
         <div class="section-title" data-aos="fade-left">
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <span><h5><?php echo strtoupper($Admin) . " -- $totalRows_ListeEtb &eacute;tablissements."; ?></h5></span>
                </div>
                <div class="col-lg-6 text-end" data-aos="fade-right">
                    <strong class="titre-rouge">Filtre</strong>&nbsp;:&nbsp; <select class="form-select-sm " style='width: 25%;display: inline;'  onChange="location.href=''+this.options[this.selectedIndex].value+'';">
                                <option value=""></option>
                                ...
                                <option value="monitoring_stats.php">Statistiques</option>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">En Cours</li>
...
<table  border="0" class="table  ">
  ...
  <?php while ($row_ListeEtb = $ListeEtb->fetchObject()) { ?>
    <tr class="<?php if ($row_ListeEtb->Situation_Etablissement == NON_FCT) {echo "table-warning";}else if($row_ListeEtb->KOBO == '1' ) {echo "table-success";}  ?> ">
            ...
            ?>          
      <td><?php echo $row_ListeEtb->Code_dspss1; ?></td>
      <td><?php echo htmlentities($row_ListeEtb->Nom_Etablissement); ?></td>
