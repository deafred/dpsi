          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex ">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form method="post" action="script_menu.php">

                  <div class="d-flex align-items-center mb-3 pb-1">
                    
                    <span class="h1 fw-bold mb-0"><i class="bi bi-columns-gap fa-2x me-3" style="color: blue;"></i>Choississez votre profil!</span>
                  </div>
                  ...
                  <div class="form-outline mb-4 d-grid gap-2">
                          ...
                          <button class="btn btn-primary" type="submit" name="agent_etb">Je suis agent d'un etablissement</button>
                          <button class="btn btn-success" type="submit" name="agent_dr">Je suis agent d'une DR</button>
                          <button class="btn btn-warning" type="submit" name="agent_dpsi">Je suis agent de la DPSI</button>
