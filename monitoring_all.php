...
if (isset($_SESSION['MM_Adminname']) && isset($_SESSION['MM_Admincode'])) {
    ...
    //Debut de tous les etablissements
        ...
        if($Admin=="admin"){
            $query_ListeEtb = "SELECT * FROM etablissement order by Nom_Etablissement";
        }else{
            $query_ListeEtb = "SELECT * FROM etablissement where Agent_Respo ='$Admin' order by Nom_Etablissement";
        }
...
<table  border="0" class="table  ">
  <tr div class="table-primary text-center">
    ...
    <th scope="col" class="numero">Contact1</th>
  ...
  <?php while ($row_ListeEtb = $ListeEtb->fetchObject()) { ?>
    <tr class="<?php if ($row_ListeEtb->Situation_Etablissement == NON_FCT) {echo "table-warning";}else if($row_ListeEtb->KOBO == '1' ) {echo "table-success";}  ?> ">
      ...
      <td><?php echo $row_ListeEtb->Tel1_Etablissement; ?></td>
